...
const url = `${CFG.CONNECTLY_API_URL}/${CFG.CONNECTLY_BUSINESS_ID}/send/campaigns`;
const API_KEY = CFG.CONNECTLY_API_KEY;  // Replace with a real token if needed
const BATCH_SIZE = CFG.BATCH_SIZE;
