...
// *****
  { communicationChannel: CHANNEL.PushNotification, locationId: LOCATION.BAQ, storeStatus: STORE_STATUS.Churn, from: 90, to: 119, frequency: 3 },
  { communicationChannel: CHANNEL.PushNotification, locationId: LOCATION.BAQ, storeStatus: STORE_STATUS.Hibernating, frequency: 3 },
  { communicationChannel: CHANNEL.PushNotification, locationId: LOCATION.BAQ, storeStatus: STORE_STATUS.Lead, frequency: 7 },
  { communicationChannel: CHANNEL.PushNotification, locationId: LOCATION.BAQ, storeStatus: STORE_STATUS.New, frequency: 3 },
  { communicationChannel: CHANNEL.PushNotification, locationId: LOCATION.BAQ, storeStatus: STORE_STATUS.Resurrected, frequency: 3 },
  { communicationChannel: CHANNEL.PushNotification, locationId: LOCATION.BAQ, storeStatus: STORE_STATUS.Retained, frequency: 3 },
  ...
  { communicationChannel: CHANNEL.PushNotification, locationId: LOCATION.BOG, storeStatus: STORE_STATUS.Churn, from: 180, to: 209, frequency: 3 },
  { communicationChannel: CHANNEL.PushNotification, locationId: LOCATION.BOG, storeStatus: STORE_STATUS.Churn, from: 210, to: 359, frequency: 3 },
  { communicationChannel: CHANNEL.PushNotification, locationId: LOCATION.BOG, storeStatus: STORE_STATUS.Hibernating, frequency: 2 },
  { communicationChannel: CHANNEL.PushNotification, locationId: LOCATION.BOG, storeStatus: STORE_STATUS.Lead, frequency: 3 },
  ...
  { communicationChannel: CHANNEL.PushNotification, locationId: LOCATION.CMX, storeStatus: STORE_STATUS.Lead, frequency: 0 },
  { communicationChannel: CHANNEL.PushNotification, locationId: LOCATION.CMX, storeStatus: STORE_STATUS.New, frequency: 7 },
  { communicationChannel: CHANNEL.PushNotification, locationId: LOCATION.CMX, storeStatus: STORE_STATUS.Resurrected, frequency: 7 },
  { communicationChannel: CHANNEL.PushNotification, locationId: LOCATION.CMX, storeStatus: STORE_STATUS.Retained, frequency: 7 },

  { communicationChannel: CHANNEL.PushNotification, locationId: LOCATION.MDE, storeStatus: STORE_STATUS.Churn, from: 90, to: 119, frequency: 3},
  { communicationChannel: CHANNEL.PushNotification, locationId: LOCATION.MDE, storeStatus: STORE_STATUS.Hibernating, frequency: 3},
  { communicationChannel: CHANNEL.PushNotification, locationId: LOCATION.MDE, storeStatus: STORE_STATUS.Lead, frequency: 7 },
  { communicationChannel: CHANNEL.PushNotification, locationId: LOCATION.MDE, storeStatus: STORE_STATUS.New, frequency: 3 },
  { communicationChannel: CHANNEL.PushNotification, locationId: LOCATION.MDE, storeStatus: STORE_STATUS.Resurrected, frequency: 3 },
  { communicationChannel: CHANNEL.PushNotification, locationId: LOCATION.MDE, storeStatus: STORE_STATUS.Retained, frequency: 3 },
