...
export const frequencyByLocationAndStatusAndRange: IFrequencyParameter[] = Config.parameter.frequencies;
// [
...
//   { communicationChannel: CHANNEL.PushNotification, locationId: LOCATION.SAO, storeStatus: STORE_STATUS.Churn, from: 90, to: 119, frequency: 2 },
//   { communicationChannel: CHANNEL.PushNotification, locationId: LOCATION.SAO, storeStatus: STORE_STATUS.Churn, from: 120, to: 149, frequency: 2 },
//   { communicationChannel: CHANNEL.PushNotification, locationId: LOCATION.SAO, storeStatus: STORE_STATUS.Churn, from: 150, to: 179, frequency: 2 },
//   { communicationChannel: CHANNEL.PushNotification, locationId: LOCATION.SAO, storeStatus: STORE_STATUS.Churn, from: 180, to: 209, frequency: 2 },
//   { communicationChannel: CHANNEL.PushNotification, locationId: LOCATION.SAO, storeStatus: STORE_STATUS.Churn, from: 210, to: 359, frequency: 2 },
//   { communicationChannel: CHANNEL.PushNotification, locationId: LOCATION.SAO, storeStatus: STORE_STATUS.Churn, from: 360, to: 449, frequency: 3 },
//   { communicationChannel: CHANNEL.PushNotification, locationId: LOCATION.SAO, storeStatus: STORE_STATUS.Churn, from: 450, to: 539, frequency: 3 },
//   { communicationChannel: CHANNEL.PushNotification, locationId: LOCATION.SAO, storeStatus: STORE_STATUS.Churn, from: 540, to: 719, frequency: 3 },
//   { communicationChannel: CHANNEL.PushNotification, locationId: LOCATION.SAO, storeStatus: STORE_STATUS.Churn, from: 720, to: 899, frequency: 4 },
//   { communicationChannel: CHANNEL.PushNotification, locationId: LOCATION.SAO, storeStatus: STORE_STATUS.Churn, from: 900, to: 1079, frequency: 4 },
//   { communicationChannel: CHANNEL.PushNotification, locationId: LOCATION.SAO, storeStatus: STORE_STATUS.Hibernating, frequency: 2 },
//   { communicationChannel: CHANNEL.PushNotification, locationId: LOCATION.SAO, storeStatus: STORE_STATUS.Lead, frequency: 2 },
//   { communicationChannel: CHANNEL.PushNotification, locationId: LOCATION.SAO, storeStatus: STORE_STATUS.New, frequency: 2 },
//   { communicationChannel: CHANNEL.PushNotification, locationId: LOCATION.SAO, storeStatus: STORE_STATUS.Resurrected, frequency: 2 },
//   { communicationChannel: CHANNEL.PushNotification, locationId: LOCATION.SAO, storeStatus: STORE_STATUS.Retained, frequency: 2 },
