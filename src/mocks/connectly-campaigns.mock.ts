...
export const connectlyConnectlyCampaigns: IConnectlyCampaignParameter[] = [
  ...
  // { name: 'API_Churn.90to119_17_es_v0', variables: NAME.concat(generateParams(SKU_DSCT_IMG, 5)), paths: generateParams(PATH, 5) },
  // { name: 'API_Churn.120to149_17_es_v0', variables: NAME.concat(generateParams(SKU_DSCT_IMG, 5)), paths: generateParams(PATH, 5) },
  // { name: 'API_Churn.150to179_17_es_v0', variables: NAME.concat(generateParams(SKU_DSCT_IMG, 5)), paths: generateParams(PATH, 5) },
  // { name: 'API_Churn.180to209_17_es_v0', variables: NAME.concat(generateParams(SKU_DSCT_IMG, 5)), paths: generateParams(PATH, 5) },
